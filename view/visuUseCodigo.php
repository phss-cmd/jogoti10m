...
?>
    <tr>
      ...
      <td>
        ...
        <input type="hidden" value="<?=$codigousu["idusu"]?>" name="codigousu">
...
<button type="button" class="btn btn-danger" codigo="<?=$codigousu["idusu"]?>"  data-bs-toggle="modal" data-bs-target="#deleteModal">
  Excluir
</button>
